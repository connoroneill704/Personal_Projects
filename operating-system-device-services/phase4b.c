...
* File: phase4b.c
* This is used to simulate the clock, terminal, and disk devices
* and how reading and writing to the disk works
* uses daemons to handle the devices
*/
#include "usloss.h"
#include "usyscall.h"
#include "phase4.h"
...
//phase 4 initilization for globals and initlizing the locks
void phase4_init(){
      currentTicks = 0;
